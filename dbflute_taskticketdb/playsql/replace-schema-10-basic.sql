...
(
	...
	MEMBER_ID BIGINT NOT NULL COMMENT 'メンバーID : このステータスを作ったメンバー',
...
(
	...
	MEMBER_ID BIGINT NOT NULL COMMENT 'メンバーID : このチケットタイプを作ったメンバー',
...
ALTER TABLE TICKET_STATUS
	ADD CONSTRAINT FK_TICKET_STATUS_MEMBER FOREIGN KEY (MEMBER_ID)
	REFERENCES MEMBER (MEMBER_ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
ALTER TABLE TICKET_TYPE
	ADD CONSTRAINT FK_TICKET_TYPE_MEMBER FOREIGN KEY (MEMBER_ID)
	REFERENCES MEMBER (MEMBER_ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
