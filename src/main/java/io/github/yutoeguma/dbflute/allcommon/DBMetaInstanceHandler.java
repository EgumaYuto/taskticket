 ...
 */
package io.github.yutoeguma.dbflute.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("TICKET", "io.github.yutoeguma.dbflute.bsentity.dbmeta.TicketDbm");
        tmpMap.put("TICKET_STATUS", "io.github.yutoeguma.dbflute.bsentity.dbmeta.TicketStatusDbm");
        tmpMap.put("TICKET_TYPE", "io.github.yutoeguma.dbflute.bsentity.dbmeta.TicketTypeDbm");
