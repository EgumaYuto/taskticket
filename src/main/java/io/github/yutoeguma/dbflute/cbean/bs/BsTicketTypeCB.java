...
/**
 * The base condition-bean of TICKET_TYPE.
 * @author DBFlute(AutoGenerator)
 */
public class BsTicketTypeCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TicketTypeCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTicketTypeCB() {
     ...
     * @return this. (NotNull)
     */
    public TicketTypeCB acceptPK(Long ticketTypeId) {
        assertObjectNotNull("ticketTypeId", ticketTypeId);
        BsTicketTypeCB cb = this;
        cb.query().setTicketTypeId_Equal(ticketTypeId);
    ...
    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_TicketTypeId_Desc();
        return this;
    }
     ...
     */
    public TicketTypeCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return doGetConditionQuery();
    }

    public TicketTypeCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TicketTypeCQ doGetConditionQuery() {
    ...
    protected TicketTypeCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TicketTypeCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TicketTypeCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TicketTypeCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TicketTypeCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TicketTypeCB> unionCBLambda) {
        final TicketTypeCB cb = new TicketTypeCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TicketTypeCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TicketTypeCB> unionCBLambda) {
        final TicketTypeCB cb = new TicketTypeCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TicketTypeCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<TicketTypeCQ> {
         ...
         */
        public HpSDRFunction<TicketCB, TicketTypeCQ> derivedTicket() {
            assertDerived("ticketList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TicketCB> sq, TicketTypeCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<TicketTypeCB, TicketTypeCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TicketTypeCB> sq, TicketTypeCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TicketTypeCB dreamCruiseCB() {
        TicketTypeCB cb = new TicketTypeCB();
        cb.xsetupForDreamCruise((TicketTypeCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TicketTypeCB> columnQuery(final SpecifyQuery<TicketTypeCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TicketTypeCB xcreateColumnQueryCB() {
        TicketTypeCB cb = new TicketTypeCB();
        cb.xsetupForColumnQuery((TicketTypeCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TicketTypeCB> orCBLambda) {
        xorSQ((TicketTypeCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TicketTypeCB> andCBLambda) {
        xorSQAP((TicketTypeCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TicketTypeCB cb;
        if (mainCB != null) {
            cb = (TicketTypeCB)mainCB;
        } else {
            cb = new TicketTypeCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TicketTypeCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TicketTypeCQ.class.getName(); }
