...
/**
 * The condition-query for in-line of PROJECT.
 * @author DBFlute(AutoGenerator)
 */
public class ProjectCIQ extends AbstractBsProjectCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsProjectCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ProjectCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsProjectCQ myCQ) {
    ...
    public String keepProjectId_ExistsReferrer_ProjectMemberList(ProjectMemberCQ sq)
    ...
    public String keepProjectId_QueryDerivedReferrer_ProjectMemberListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    ...
    public String keepScalarCondition(ProjectCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ProjectCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ProjectCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ProjectCQ sq)
    ...
    protected String xinCB() { return ProjectCB.class.getName(); }
    protected String xinCQ() { return ProjectCQ.class.getName(); }
}
