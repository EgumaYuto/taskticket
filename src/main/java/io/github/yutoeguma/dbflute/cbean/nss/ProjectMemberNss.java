...
import io.github.yutoeguma.dbflute.cbean.cq.ProjectMemberCQ;

/**
 * The nest select set-upper of PROJECT_MEMBER.
 * @author DBFlute(AutoGenerator)
 */
public class ProjectMemberNss {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final ProjectMemberCQ _query;
    public ProjectMemberNss(ProjectMemberCQ query) { _query = query; }
