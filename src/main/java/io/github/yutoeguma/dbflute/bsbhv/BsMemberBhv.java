...
/**
 * The behavior of (メンバー)MEMBER as TABLE. <br>
 * <pre>
 * [primary key]
 *     MEMBER_ID
 *
...
public abstract class BsMemberBhv extends AbstractBehaviorWritable<Member, MemberCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<Member> selectByUniqueOf(String emailAddress) {
        return facadeSelectByUniqueOf(emailAddress);
    }

    protected OptionalEntity<Member> facadeSelectByUniqueOf(String emailAddress) {
        return doSelectByUniqueOf(emailAddress, typeOfSelectedEntity());
    }

    protected <ENTITY extends Member> OptionalEntity<ENTITY> doSelectByUniqueOf(String emailAddress, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(emailAddress), tp), emailAddress);
    }

    protected MemberCB xprepareCBAsUniqueOf(String emailAddress) {
     ...
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadProject</span>(<span style="color: #553000">memberList</span>, <span style="color: #553000">projectCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public NestedReferrerListGateway<Project> loadProject(List<Member> memberList, ReferrerConditionSetupper<ProjectCB> refCBLambda) {
        xassLRArg(memberList, refCBLambda);
        return doLoadProject(memberList, new LoadReferrerOption<ProjectCB, Project>().xinit(refCBLambda));
    }
     ...
     * (プロジェクト)PROJECT by MEMBER_ID, named 'projectList'.
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadProject</span>(<span style="color: #553000">member</span>, <span style="color: #553000">projectCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">projectCB</span>.setupSelect...
     *     <span style="color: #553000">projectCB</span>.query().set...
     *     <span style="color: #553000">projectCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">member</span>.<span style="color: #CC4747">getProjectList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Project> loadProject(Member member, ReferrerConditionSetupper<ProjectCB> refCBLambda) {
        xassLRArg(member, refCBLambda);
        return doLoadProject(xnewLRLs(member), new LoadReferrerOption<ProjectCB, Project>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Project> doLoadProject(List<Member> memberList, LoadReferrerOption<ProjectCB, Project> option) {
        return helpLoadReferrerInternally(memberList, option, "projectList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadProjectMember</span>(<span style="color: #553000">memberList</span>, <span style="color: #553000">memberCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<ProjectMember> loadProjectMember(List<Member> memberList, ReferrerConditionSetupper<ProjectMemberCB> refCBLambda) {
        xassLRArg(memberList, refCBLambda);
        return doLoadProjectMember(memberList, new LoadReferrerOption<ProjectMemberCB, ProjectMember>().xinit(refCBLambda));
    }
     ...
     * (プロジェクトメンバー)PROJECT_MEMBER by MEMBER_ID, named 'projectMemberList'.
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadProjectMember</span>(<span style="color: #553000">member</span>, <span style="color: #553000">memberCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">memberCB</span>.setupSelect...
     *     <span style="color: #553000">memberCB</span>.query().set...
     *     <span style="color: #553000">memberCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">member</span>.<span style="color: #CC4747">getProjectMemberList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<ProjectMember> loadProjectMember(Member member, ReferrerConditionSetupper<ProjectMemberCB> refCBLambda) {
        xassLRArg(member, refCBLambda);
        return doLoadProjectMember(xnewLRLs(member), new LoadReferrerOption<ProjectMemberCB, ProjectMember>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<ProjectMember> doLoadProjectMember(List<Member> memberList, LoadReferrerOption<ProjectMemberCB, ProjectMember> option) {
        return helpLoadReferrerInternally(memberList, option, "projectMemberList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadTicketByAssigneedMemberId</span>(<span style="color: #553000">memberList</span>, <span style="color: #553000">ticketCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Ticket> loadTicketByAssigneedMemberId(List<Member> memberList, ReferrerConditionSetupper<TicketCB> refCBLambda) {
        xassLRArg(memberList, refCBLambda);
        return doLoadTicketByAssigneedMemberId(memberList, new LoadReferrerOption<TicketCB, Ticket>().xinit(refCBLambda));
    }
     ...
     * (チケット)TICKET by ASSIGNEED_MEMBER_ID, named 'ticketByAssigneedMemberIdList'.
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadTicketByAssigneedMemberId</span>(<span style="color: #553000">member</span>, <span style="color: #553000">ticketCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">ticketCB</span>.setupSelect...
     *     <span style="color: #553000">ticketCB</span>.query().set...
     *     <span style="color: #553000">ticketCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">member</span>.<span style="color: #CC4747">getTicketByAssigneedMemberIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Ticket> loadTicketByAssigneedMemberId(Member member, ReferrerConditionSetupper<TicketCB> refCBLambda) {
        xassLRArg(member, refCBLambda);
        return doLoadTicketByAssigneedMemberId(xnewLRLs(member), new LoadReferrerOption<TicketCB, Ticket>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Ticket> doLoadTicketByAssigneedMemberId(List<Member> memberList, LoadReferrerOption<TicketCB, Ticket> option) {
        return helpLoadReferrerInternally(memberList, option, "ticketByAssigneedMemberIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadTicketByMemberId</span>(<span style="color: #553000">memberList</span>, <span style="color: #553000">ticketCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">ticketCB</span>.setupSelect...
     *     <span style="color: #553000">ticketCB</span>.query().set...
     *     <span style="color: #553000">ticketCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Ticket> loadTicketByMemberId(List<Member> memberList, ReferrerConditionSetupper<TicketCB> refCBLambda) {
        xassLRArg(memberList, refCBLambda);
        return doLoadTicketByMemberId(memberList, new LoadReferrerOption<TicketCB, Ticket>().xinit(refCBLambda));
    }
     ...
     * (チケット)TICKET by MEMBER_ID, named 'ticketByMemberIdList'.
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadTicketByMemberId</span>(<span style="color: #553000">member</span>, <span style="color: #553000">ticketCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">ticketCB</span>.setupSelect...
     *     <span style="color: #553000">ticketCB</span>.query().set...
     *     <span style="color: #553000">ticketCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">member</span>.<span style="color: #CC4747">getTicketByMemberIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Ticket> loadTicketByMemberId(Member member, ReferrerConditionSetupper<TicketCB> refCBLambda) {
        xassLRArg(member, refCBLambda);
        return doLoadTicketByMemberId(xnewLRLs(member), new LoadReferrerOption<TicketCB, Ticket>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Ticket> doLoadTicketByMemberId(List<Member> memberList, LoadReferrerOption<TicketCB, Ticket> option) {
        return helpLoadReferrerInternally(memberList, option, "ticketByMemberIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadTicketStatus</span>(<span style="color: #553000">memberList</span>, <span style="color: #553000">statusCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (Member member : <span style="color: #553000">memberList</span>) {
     *     ... = member.<span style="color: #CC4747">getTicketStatusList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TicketStatus> loadTicketStatus(List<Member> memberList, ReferrerConditionSetupper<TicketStatusCB> refCBLambda) {
        xassLRArg(memberList, refCBLambda);
        return doLoadTicketStatus(memberList, new LoadReferrerOption<TicketStatusCB, TicketStatus>().xinit(refCBLambda));
    }
     ...
     * (チケットステータス)TICKET_STATUS by MEMBER_ID, named 'ticketStatusList'.
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadTicketStatus</span>(<span style="color: #553000">member</span>, <span style="color: #553000">statusCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">statusCB</span>.setupSelect...
     *     <span style="color: #553000">statusCB</span>.query().set...
     *     <span style="color: #553000">statusCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">member</span>.<span style="color: #CC4747">getTicketStatusList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TicketStatus> loadTicketStatus(Member member, ReferrerConditionSetupper<TicketStatusCB> refCBLambda) {
        xassLRArg(member, refCBLambda);
        return doLoadTicketStatus(xnewLRLs(member), new LoadReferrerOption<TicketStatusCB, TicketStatus>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<TicketStatus> doLoadTicketStatus(List<Member> memberList, LoadReferrerOption<TicketStatusCB, TicketStatus> option) {
        return helpLoadReferrerInternally(memberList, option, "ticketStatusList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadTicketType</span>(<span style="color: #553000">memberList</span>, <span style="color: #553000">typeCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (Member member : <span style="color: #553000">memberList</span>) {
     *     ... = member.<span style="color: #CC4747">getTicketTypeList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TicketType> loadTicketType(List<Member> memberList, ReferrerConditionSetupper<TicketTypeCB> refCBLambda) {
        xassLRArg(memberList, refCBLambda);
        return doLoadTicketType(memberList, new LoadReferrerOption<TicketTypeCB, TicketType>().xinit(refCBLambda));
    }
     ...
     * (チケットタイプ)TICKET_TYPE by MEMBER_ID, named 'ticketTypeList'.
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadTicketType</span>(<span style="color: #553000">member</span>, <span style="color: #553000">typeCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">typeCB</span>.setupSelect...
     *     <span style="color: #553000">typeCB</span>.query().set...
     *     <span style="color: #553000">typeCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">member</span>.<span style="color: #CC4747">getTicketTypeList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TicketType> loadTicketType(Member member, ReferrerConditionSetupper<TicketTypeCB> refCBLambda) {
        xassLRArg(member, refCBLambda);
        return doLoadTicketType(xnewLRLs(member), new LoadReferrerOption<TicketTypeCB, TicketType>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<TicketType> doLoadTicketType(List<Member> memberList, LoadReferrerOption<TicketTypeCB, TicketType> option) {
        return helpLoadReferrerInternally(memberList, option, "ticketTypeList");
    }
