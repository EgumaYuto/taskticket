...
import io.github.yutoeguma.mylasta.action.TaskticketLabels;
 ...
 * @author FreeGen
 */
public class TaskticketMessages extends TaskticketLabels {
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsAssertFalseMessage(String property) {
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsAssertTrueMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsDecimalMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsDecimalMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsDigitsMessage(String property, String integer, String fraction) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsFutureMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsNotNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsPastMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsPatternMessage(String property, String regexp) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsSizeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsCreditCardNumberMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsEanMessage(String property, String type) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsEmailMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsLengthMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsLuhnCheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsMod10CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsMod11CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsModCheckMessage(String property, String value, String modType) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsNotBlankMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsNotEmptyMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsParametersScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsRangeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsSafeHtmlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsUrlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsRequiredMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsTypeAnyMessage(String property, String propertyType) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsTypeIntegerMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsTypeLongMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsTypeLocalDateMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsTypeLocalDateTimeMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addConstraintsTypeBooleanMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addErrorsLoginFailure(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addErrorsAppIllegalTransition(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addErrorsAppDbAlreadyDeleted(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addErrorsAppDbAlreadyUpdated(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addErrorsAppDbAlreadyExists(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addErrorsAppDoubleSubmitRequest(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TaskticketMessages addErrorsSignupAccountAlreadyExists(String property) {
        assertPropertyNotNull(property);
