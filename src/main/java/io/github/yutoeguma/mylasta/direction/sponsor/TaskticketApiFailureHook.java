...
import io.github.yutoeguma.mylasta.direction.sponsor.TaskticketApiFailureHook.UnifiedFailureResult.FailureErrorPart;
 ...
 * @author jflute
 */
public class TaskticketApiFailureHook implements ApiFailureHook { // #change_it for handling API failure
    ...
    public static class UnifiedFailureResult {
        ...
        public final String notice = "[Attension] tentative JSON so you should change it: " + TaskticketApiFailureHook.class;
