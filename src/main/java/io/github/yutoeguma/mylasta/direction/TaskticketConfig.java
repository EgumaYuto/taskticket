...
import io.github.yutoeguma.mylasta.direction.TaskticketEnv;
import org.lastaflute.core.direction.exception.ConfigPropertyNotFoundException;

/**
 * @author FreeGen
 */
public interface TaskticketConfig extends TaskticketEnv {

    /** The key of the configuration. e.g. taskticket */
    ...
    /** The key of the configuration. e.g. TASKKEY */
    String COOKIE_REMEMBER_ME_TASKTICKET_KEY = "cookie.remember.me.taskticket.key";
     ...
     * The value is, e.g. taskticket <br>
    ...
    public static class SimpleImpl extends TaskticketEnv.SimpleImpl implements TaskticketConfig {
        ...
        public String getDomainName() {
            return get(TaskticketConfig.DOMAIN_NAME);
        }

        public String getDomainTitle() {
            return get(TaskticketConfig.DOMAIN_TITLE);
        }

        public String getAppStandardDatePattern() {
            return get(TaskticketConfig.APP_STANDARD_DATE_PATTERN);
        }

        public String getAppStandardDatetimePattern() {
            return get(TaskticketConfig.APP_STANDARD_DATETIME_PATTERN);
        }

        public String getAppStandardTimePattern() {
            return get(TaskticketConfig.APP_STANDARD_TIME_PATTERN);
        }

        public String getCookieDefaultPath() {
            return get(TaskticketConfig.COOKIE_DEFAULT_PATH);
        }

        public String getCookieDefaultExpire() {
            return get(TaskticketConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public Integer getCookieDefaultExpireAsInteger() {
            return getAsInteger(TaskticketConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public String getCookieEternalExpire() {
            return get(TaskticketConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public Integer getCookieEternalExpireAsInteger() {
            return getAsInteger(TaskticketConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public String getCookieRememberMeTaskticketKey() {
            return get(TaskticketConfig.COOKIE_REMEMBER_ME_TASKTICKET_KEY);
        }
    }
}
