 ...
 * @author jflute
 */
public class TaskticketSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public TaskticketSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
