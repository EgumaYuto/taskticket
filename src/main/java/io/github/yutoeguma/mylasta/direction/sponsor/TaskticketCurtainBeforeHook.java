 ...
 * @author jflute
 */
public class TaskticketCurtainBeforeHook implements CurtainBeforeHook {
    ...
    protected DfFinalTimeZoneProvider createFinalTimeZoneProvider() {
        return new DfFinalTimeZoneProvider() {
            protected final TimeZone provided = TaskticketUserTimeZoneProcessProvider.centralTimeZone;
