 ...
 * @author FreeGen
 */
public interface TaskticketEnv {
    ...
    /** The key of the configuration. e.g. /tmp/lastaflute/taskticket */
    ...
    /** The key of the configuration. e.g. returnpath@yutoeguma.github.io */
    String MAIL_RETURN_PATH = "mail.return.path";

    /** The key of the configuration. e.g. taskticket-support@annie.example.com */
    String MAIL_ADDRESS_SUPPORT = "mail.address.support";

    /** The key of the configuration. e.g. com.mysql.jdbc.Driver */
    String JDBC_DRIVER = "jdbc.driver";

    /** The key of the configuration. e.g. jdbc:mysql://localhost:3306/taskticketdb */
    String JDBC_URL = "jdbc.url";

    /** The key of the configuration. e.g. taskticketdb */
    ...
    /** The key of the configuration. e.g. localhost:8090/taskticket */
     ...
     * The value is, e.g. /tmp/lastaflute/taskticket <br>
     ...
     * The value is, e.g. returnpath@yutoeguma.github.io <br>
     ...
     * The value is, e.g. taskticket-support@annie.example.com <br>
     * comment: Mail Address for Taskticket Support
     * @return The value of found property. (NotNull: if not found, exception but basically no way)
     */
     ...
     * The value is, e.g. jdbc:mysql://localhost:3306/taskticketdb <br>
     ...
     * The value is, e.g. taskticketdb <br>
     ...
     * The value is, e.g. localhost:8090/taskticket <br>
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends ObjectiveConfig implements TaskticketEnv {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getLastaDiSmartDeployMode() {
            return get(TaskticketEnv.lasta_di_SMART_DEPLOY_MODE);
        }

        public String getDevelopmentHere() {
            return get(TaskticketEnv.DEVELOPMENT_HERE);
        }

        public boolean isDevelopmentHere() {
            return is(TaskticketEnv.DEVELOPMENT_HERE);
        }

        public String getEnvironmentTitle() {
            return get(TaskticketEnv.ENVIRONMENT_TITLE);
        }

        public String getFrameworkDebug() {
            return get(TaskticketEnv.FRAMEWORK_DEBUG);
        }

        public boolean isFrameworkDebug() {
            return is(TaskticketEnv.FRAMEWORK_DEBUG);
        }

        public String getTimeAdjustTimeMillis() {
            return get(TaskticketEnv.TIME_ADJUST_TIME_MILLIS);
        }

        public Long getTimeAdjustTimeMillisAsLong() {
            return getAsLong(TaskticketEnv.TIME_ADJUST_TIME_MILLIS);
        }

        public String getLogLevel() {
            return get(TaskticketEnv.LOG_LEVEL);
        }

        public String getLogConsoleLevel() {
            return get(TaskticketEnv.LOG_CONSOLE_LEVEL);
        }

        public String getLogFileBasedir() {
            return get(TaskticketEnv.LOG_FILE_BASEDIR);
        }

        public String getMailSendMock() {
            return get(TaskticketEnv.MAIL_SEND_MOCK);
        }

        public boolean isMailSendMock() {
            return is(TaskticketEnv.MAIL_SEND_MOCK);
        }

        public String getMailSmtpServerMainHostAndPort() {
            return get(TaskticketEnv.MAIL_SMTP_SERVER_MAIN_HOST_AND_PORT);
        }

        public String getMailSubjectTestPrefix() {
            return get(TaskticketEnv.MAIL_SUBJECT_TEST_PREFIX);
        }

        public String getMailReturnPath() {
            return get(TaskticketEnv.MAIL_RETURN_PATH);
        }

        public String getMailAddressSupport() {
            return get(TaskticketEnv.MAIL_ADDRESS_SUPPORT);
        }

        public String getJdbcDriver() {
            return get(TaskticketEnv.JDBC_DRIVER);
        }

        public String getJdbcUrl() {
            return get(TaskticketEnv.JDBC_URL);
        }

        public String getJdbcUser() {
            return get(TaskticketEnv.JDBC_USER);
        }

        public String getJdbcPassword() {
            return get(TaskticketEnv.JDBC_PASSWORD);
        }

        public String getJdbcConnectionPoolingSize() {
            return get(TaskticketEnv.JDBC_CONNECTION_POOLING_SIZE);
        }

        public Integer getJdbcConnectionPoolingSizeAsInteger() {
            return getAsInteger(TaskticketEnv.JDBC_CONNECTION_POOLING_SIZE);
        }

        public String getServerDomain() {
            return get(TaskticketEnv.SERVER_DOMAIN);
        }
    }
}
