...
.project {
  ...
  .project.is-white {
    background-color: white;
    color: #0a0a0a; }
    .project.is-white a:hover {
      background-color: #e6e6e6; }
  .project.is-black {
    background-color: #0a0a0a;
    color: white; }
    .project.is-black a:hover {
      background-color: black; }
  .project.is-light {
    background-color: whitesmoke;
    color: #363636; }
    .project.is-light a:hover {
      background-color: #dbdbdb; }
  .project.is-dark {
    background-color: #363636;
    color: whitesmoke; }
    .project.is-dark a:hover {
      background-color: #1c1c1c; }
  .project.is-primary {
    background-color: #00d1b2;
    color: #fff; }
    .project.is-primary a:hover {
      background-color: #009e86; }
  .project.is-info {
    background-color: #3273dc;
    color: #fff; }
    .project.is-info a:hover {
      background-color: #205bbc; }
  .project.is-success {
    background-color: #23d160;
    color: #fff; }
    .project.is-success a:hover {
      background-color: #1ca64c; }
  .project.is-warning {
    background-color: #ffdd57;
    color: rgba(0, 0, 0, 0.7); }
    .project.is-warning a:hover {
      background-color: #ffd324; }
  .project.is-danger {
    background-color: #ff3860;
    color: #fff; }
    .project.is-danger a:hover {
...
/*# sourceMappingURL=my-bluma.css.map */
